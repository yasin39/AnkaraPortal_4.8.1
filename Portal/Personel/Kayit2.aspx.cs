    ...
    public partial class Kayit2 : System.Web.UI.Page
    {
        ...
        private PersonelModel CreatePersonelFromForm()
        {
            PersonelModel personel = new PersonelModel
            {
                ...
                FotografYolu = hfFotografYolu.Value,
        ...
        private void ClearForm()
        {
            ...
            hfFotografYolu.Value = "";

            // Fotoğraf önizleme temizle
            imgPreview.ImageUrl = "";
        ...
        private void PopulateFormWithPersonel(PersonelModel personel)
        {
            ...
            hfFotografYolu.Value = personel.FotografYolu ?? "";
            ...
            {
                imgPreview.ImageUrl = personel.FotografYolu;
